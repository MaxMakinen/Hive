...
/*   Updated: 2022/05/08 20:02:12 by mmakinen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

int	get_len(long num, int base, int *neg)
{
	int	len;
...
void	prefix(char *str, int base, int neg)
{
	if (base != 10)
	{
		str[0] = '0';
...
void	check_neg(long *num, int *neg, int base)
{
	if (*num < 0)
	{
		*num *= -1;
